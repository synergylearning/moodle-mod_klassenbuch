...
/**
 * The mod_klassenbuch chapter viewed event.
 *
...
/**
 * The mod_klassenbuch chapter viewed event class.
 *
 * @package    mod_klassenbuch
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class chapter_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the chapter with id '$this->objectid' for the klassenbuch with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'klassenbuch', 'view chapter', 'view.php?id=' . $this->contextinstanceid .
    ...
    public static function get_name() {
        return get_string('eventchapterviewed', 'mod_klassenbuch');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/klassenbuch/view.php', array('id' => $this->contextinstanceid, 'chapterid' => $this->objectid));
    }
