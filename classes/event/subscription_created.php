...
/**
 * The mod_klassenbuch subscription created event.
 *
...
/**
 * The mod_klassenbuch subscription created event class.
 *
 * @property-read array $other {
 *      Extra information about the event.
 *
 *      - int bookid: The id of the klassenbuch which has been subscribed to.
 * }
 *
 * @package    mod_klassenbuch
 * @since      Moodle 2.7
...
class subscription_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' subscribed the user with id '$this->relateduserid' to the klassenbuch with " .
    ...
    public static function get_name() {
        return get_string('eventsubscriptioncreated', 'mod_klassenbuch');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'klassenbuch', 'subscribe', 'subscribers.php?id='.$this->other['bookid'],
